...
class Container_58eef0999e extends _PHPStan_18cddd6e5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService055(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_58eef0999e $container)
			{
	...
	public function createServiceContainer(): Container_58eef0999e
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'autoload_files' => ['/var/www/html/products_symfony/vendor/phpstan/phpstan/../../vendor/autoload.php'],
